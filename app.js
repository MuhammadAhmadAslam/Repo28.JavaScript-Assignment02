...
if(opreation == "+"){
    document.write("The Addition of Number 1 and Number 2 is: " + (+calcNum1+ +calcNum2));
}
else if(opreation === "-"){
    document.write("The Subtraction of Number 1 and Number 2 is: " + (calcNum1-calcNum2));
}
else if(opreation == "*"){
    document.write("The Multiplication of Number 1 and Number 2 is: " + calcNum1*calcNum2);
}
else if(opreation == "/"){
    document.write("The Division of Number 1 and Number 2 is: " + calcNum1/calcNum2);
}